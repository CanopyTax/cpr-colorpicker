...
var _inlineStylePrefixerStatic = __webpack_require__(27);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_preact__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_preact___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_preact__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_aphrodite_no_important__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_aphrodite_no_important___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_aphrodite_no_important__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_color__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_color___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_color__);




class ColorBar extends __WEBPACK_IMPORTED_MODULE_0_preact__["Component"] {
	render() {
		return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])('div', {
			...
			onClick: e => {
				...
				this.props.barClick(__WEBPACK_IMPORTED_MODULE_2_color___default()(`hsl(${hue}, 90%, 50%)`));
			},
			'class': `${__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_aphrodite_no_important__["css"])(styles.bar)}` });
	}
}
/* harmony export (immutable) */ __webpack_exports__["a"] = ColorBar;


const colorGrad = [`hsl(0, 90%, 50%) 0%`, `hsl(60, 90%, 50%) 16%`, `hsl(120, 90%, 50%) 33%`, `hsl(180, 90%, 50%) 50%`, `hsl(240, 90%, 50%) 66%`, `hsl(300, 90%, 50%) 83%`, `hsl(360, 90%, 50%) 100%`];

const styles = __WEBPACK_IMPORTED_MODULE_1_aphrodite_no_important__["StyleSheet"].create({
	bar: {
		width: "100%",
		borderRadius: "5px",
		height: "48px",
...
var _sortPrefixedStyle = __webpack_require__(26);
...
var _flex = __webpack_require__(17);

var _flex2 = _interopRequireDefault(_flex);

var _sizing = __webpack_require__(22);
...
var _flexboxIE = __webpack_require__(18);

var _flexboxIE2 = _interopRequireDefault(_flexboxIE);

var _flexboxOld = __webpack_require__(19);
...
var _isPrefixedProperty = __webpack_require__(25);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_aphrodite_no_important__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_aphrodite_no_important___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_aphrodite_no_important__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__colorpicker_helper_js__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_color__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_color___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_color__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__bar_component_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__slider_component_js__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__slider_component_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__slider_component_js__);
...
class ColorPicker extends __WEBPACK_IMPORTED_MODULE_0_preact__["Component"] {
	constructor(props) {
		super();
		this.state = {
			color: props.color ? __WEBPACK_IMPORTED_MODULE_3_color___default()(props.color) : __WEBPACK_IMPORTED_MODULE_3_color___default()(`hsl(0, 90%, 50%)`),
			sliderSize: 0
		};
	}
	componentDidMount() {
	...
	render() {
		return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
			'div',
			{
				...
				'class': `${__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_aphrodite_no_important__["css"])(styles.colorPicker)}` },
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_4__bar_component_js__["a" /* default */], {
				barHeight: this.state.width * .09,
				barClick: this.setColor.bind(this) }),
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_5__slider_component_js___default.a, {
...
var isArrayish = __webpack_require__(37);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_color__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_color___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_color__);
/* harmony export (immutable) */ __webpack_exports__["colorToPosition"] = colorToPosition;
...
var _colorpickerHelper = __webpack_require__(38);
...
var ColorSlider = function (_Component) {
	...
	function ColorSlider() {
		...
		_this.mousemove = function (e) {
			var hue = Math.floor((e.x - _this.props.barStart) / _this.props.barWidth * 360);
			_this.props.setColor((0, _color2.default)('hsl(' + (hue >= 360 ? 359 : hue < 0 ? 0 : hue) + ', 90%, 50%)'));
		};
		...
		value: function render(props, state) {
			...
			return (0, _preact.h)('div', {
				onMouseDown: function onMouseDown(e) {
					...
					window.addEventListener('mousemove', _this2.mousemove);
					window.addEventListener('mouseup', _this2.mouseup);
				},
				style: {
					height: props.sliderSize + 'px',
					width: props.sliderSize + 'px',
					left: 'calc(' + (0, _colorpickerHelper.colorToPosition)(props.color) + '% - ' + props.sliderSize / 2 + 'px)',
					background: '' + props.color.hsl().string()
				},
				'class': (0, _noImportant.css)(styles.slider) + ' ' + (0, _noImportant.css)(this.state.dragging ? styles.grabbing : styles.grab) });
		}
	}]);
